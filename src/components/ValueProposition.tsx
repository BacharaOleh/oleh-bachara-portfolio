...
const accentThemes = {
  indigo: {
    ...
    iconBg: "bg-[#1c1917] text-amber-500 border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]",
    glowGradient: "from-amber-500/5 via-transparent to-transparent",
  },
  cyan: {
    borderHover: "hover:border-white/20",
    badge: "slate" as const,
    metricText: "text-[#f7f8f8]",
    iconBg: "bg-[#1c1917] text-[#f7f8f8] border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]",
    glowGradient: "from-white/5 via-transparent to-transparent",
  },
  violet: {
    borderHover: "hover:border-amber-500/40",
    badge: "slate" as const,
